...
Requires: python3-argon2-cffi >= 23.1.0
Requires: python3-asgiref >= 3.2.10
Requires: python3-bcrypt >= 5.0.0
...
Requires: python3-h2 >= 4.3.0
Requires: python3-hyperframe >= 6.0
Requires: python3-kaitaistruct >= 0.10
Requires: python3-ldap3 >= 2.8
Requires: python3-mitmproxy-rs >= 0.12.6
Requires: python3-msgpack >= 1.0.0
Requires: python3-publicsuffix2 >= 2.20190812
Requires: python3-pyOpenSSL >= 24.3
Requires: python3-pyparsing >= 2.4.2
Requires: python3-pyperclip >= 1.9.0
Requires: python3-ruamel.yaml >= 0.18.10
Requires: python3-sortedcontainers >= 2.3
Requires: python3-tornado >= 6.5.0
Requires: python3-typing-extensions >= 4.13.2
Requires: python3-urwid >= 2.6.14
Requires: python3-wsproto >= 1.0
Requires: python3-zstandard >= 0.25
